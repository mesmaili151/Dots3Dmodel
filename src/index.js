...
const backLight = new THREE.PointLight(0xfafafa, 3, 10);
backLight.position.set(-5, 5, 5);
mainScene.add(backLight);

const fillLight = new THREE.PointLight(0xffffff, 0, 1, 10);
fillLight.position.set(-5, 0, 5);
mainScene.add(fillLight);

const keyLight = new THREE.PointLight(0xffffff, 2, 12);
...
particleMaterial.uniforms.pointSize.value = 10.0;
